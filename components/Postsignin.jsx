...
const Postsignin = () => {
    ...
    return (
        <> 
            ...
            <form className="w-11/12 md:w-8/12 lg:w-6/12 px-8 lg:px-12 py-10 rounded-2xl border-2 border-gray-100 shadow-xl bg-white">
                <div className="relative z-0 w-full mb-5 group">
                    <input type="email" onChange={()=>{}} value={ session.status == 'authenticated' ? session.data.user?.email : ''} name="floating_email" id="floating_email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div className="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        <input type="text" name="floating_last_name" onChange={()=>{}} value={ session.status == 'authenticated' ? session.data.user?.name.split(' ')[1] : ''} id="floating_last_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
