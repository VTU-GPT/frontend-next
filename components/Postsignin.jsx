        ...
        <>
            {loading == true ? <div className='h-screen w-full flex items-center justify-center'>loading...</div> :
                <div className='w-full flex justify-center flex-col items-center gap-7'>
                    ...
                    <form className="w-11/12 md:w-8/12 lg:w-6/12 px-8 lg:px-12 py-10 rounded-2xl border-2 border-gray-100 shadow-xl bg-white" onSubmit={formSubmitHandler}>
                        ...
                        <div className="grid md:grid-cols-2 md:gap-6">
                            <div className="relative z-0 w-full mb-5 group">
                                <input type="text" onChange={(e) => setCity(e.target.value)} value={city} name="city" id="floating_first_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div className="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div className="relative z-0 w-full mb-5 group">
                                ...
                                <label htmlFor="floating_first_name" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transhtmlForm -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Scheme</label>
                            </div>
                            <div className="relative z-0 w-full mb-5 group">
