...
const AnswerPage = () => {
    ...
    return (
        <>
            ...
            <div className="answer-submenu-container flex justify-between px-5 bg-white">
                <input
                ...
                <div className='answer-box flex justify-center '>
                    <div className="">
                        {
                    ...
                    <div className="fixed bottom-4 w-3/4 m-auto flex items-center p-2 bg-white rounded-xl border focus:outline-none focus:ring focus:border-blue-300">
                    <input
                        type="text"
                    ...
                    />
                    <button
                        className="px-4 py-2 text-white bg-black rounded-3xl ml-2"
                        onClick={async (e) => {
                        setquestion('');
                        setLoading(true);
                        scrollTolast();
